...
<img src="https://raw.githubusercontent.com/PatrickAlphaC/nft-mix/main/img/HATCHBACK.png" width="225" alt="NFT Shiba Inu">
<img src="https://raw.githubusercontent.com/PatrickAlphaC/nft-mix/main/img/pug.png" width="225" alt="NFT Pug">
<img src="https://raw.githubusercontent.com/PatrickAlphaC/nft-mix/main/img/SUV.png" width="225" alt="NFT St.Bernard">
</a>
</p>
<br/>
...
They each deploy unique dogs. The advanced version gives you a random car (out of a Pug, Shiba Inu, and St. Bernard).
...
```
brownie run scripts/figa_nft/deploy_advanced.py --network rinkeby
brownie run scripts/figa_nft/create_collectible.py --network rinkeby
```
Then:
```
brownie run scripts/figa_nft/create_metadata.py --network rinkeby
brownie run scripts/figa_nft/set_tokenuri.py --network rinkeby
```
